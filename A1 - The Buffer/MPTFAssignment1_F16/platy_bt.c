...
/*create the input buffer */
 ...
 printf("--- BEFORE OPENING THE SOURCE FILE TO FILE POINTER ---\n"); /* DEBUG COMMENT - DELETE BEFORE HANDING IN ASSIGNMENT */
/* open the source file */
 ...
 printf("--- LOADING SOURCE FILE INTO BUFFER USING B_LOAD --- \n"); /* DEBUG COMMENT - DELETE BEFORE HANDING IN ASSIGNMENT */
 ...
 * display again
 */
 printf("--- BEFORE ENTERING B_PACK FUNCTION ---\n"); /* DEBUG COMMENT - DELETE BEFORE HANDING IN ASSIGNMENT */
 ...
 printf("--- BEFORE ENTERING B_FREE FUNCTION --- \n"); /* DEBUG COMMENT - DELETE BEFORE HANDING IN ASSIGNMENT */
...
void display (Buffer *ptr_Buffer){
  ...
  /* Changed identifier from %u to %zu to change platform-specific warning. */
